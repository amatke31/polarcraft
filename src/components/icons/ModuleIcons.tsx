    ...
    >
      ...
      <g>
        ...
        <circle
          ...
          cy="26"
          r="2.5"
          fill="url(#opticslab-polar-0)"
          filter="url(#opticslab-glow)"
        />
        {/* Emitter glow ring */}
        <circle
          cx="12"
