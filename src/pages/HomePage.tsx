  ...
  return (
    ...
    >
      ...
      <header className="flex flex-col items-center justify-center pt-12 pb-8 px-4 text-center">
        ...
        {/* Title */}
        <h1
          className={`text-4xl sm:text-5xl md:text-6xl font-bold mb-5 ${theme === 'dark'
        ...
        {/* Subtitle */}
        <p
          className={`text-xl sm:text-2xl font-medium mb-6 ${theme === 'dark' ? 'text-cyan-400/80' : 'text-cyan-600'
            }`}
